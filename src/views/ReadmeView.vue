...
<template>
    <div v-show="store.state.view.type === 'readme'">
        ...
        <p>单位（如  <vue-latex :expression="'kg*m/s2'"></vue-latex> ）只会影响  <vue-latex :expression="'\\LaTeX'"></vue-latex>
        ...
        <p>数据参与构成计算式前，需要先在侧栏处为数据<em>命名</em>。数据名支持  <vue-latex
                :expression="'\\LaTeX'"></vue-latex> 渲染。一般来说，建议把中文部分放在数据的<em>含义</em>内容中。
        </p>
        ...
        <h2>快捷键</h2>
        <ul>
            <li> <vue-latex :expression="'Alt/Option + w'"></vue-latex>  :选择已有数据或图表中往上一个</li>
            <li> <vue-latex :expression="'Alt/Option + s'"></vue-latex> : 选择已有数据或图表中往下一个</li>
            <li> <vue-latex :expression="'Ctrl + D'"></vue-latex> : 创建一个新的直接数据</li>
            <li> <vue-latex :expression="'Ctrl + I'"></vue-latex> : 创建一个新的间接数据</li>
            <li> <vue-latex :expression="'Ctrl + T'"></vue-latex> : 创建一个新的表格</li>
            <li> <vue-latex :expression="'Ctrl + G'"></vue-latex> : 创建一个新的图</li>
            <li> <vue-latex :expression="'Ctrl + S'"></vue-latex> : 保存当前数据</li>
            <li> <vue-latex :expression="'Ctrl + O'"></vue-latex> : 打开已有数据</li>
            <li> <vue-latex :expression="'Ctrl + N'"></vue-latex> : 创建与当前数据类型相同的数据</li>
            <li> <vue-latex :expression="'Ctrl + Shift + C'"></vue-latex> : 在应用内复制当前数据(直接数据或间接数据)；复制代码(图表)
            </li>
            <li> <vue-latex :expression="'Ctrl + Shift + V'"></vue-latex> : 黏贴并覆盖当前数据(直接数据或间接数据)</li>
            <li> <vue-latex :expression="'Ctrl + Shift + D'"></vue-latex> : 删除当前数据</li>
            <li> <vue-latex :expression="'Tab'"></vue-latex>  : 页面中选择下一选项</li>
            <li> <vue-latex :expression="'Shift + Tab'"></vue-latex>  : 页面中选择上一选项</li>
        </ul>
    </div>
</template>
