...
async function publishRelease() {
  ...
  if (releaseExists) {
    ...
    execSync(
      `gh release edit ${currentVersion} --title "Release ${currentVersion} generated by publish.js" `
    );
    ...
    // 创建新的 Release 并上传文件
    execSync(
      `gh release create ${currentVersion} ${outputDir}/package.nw.zip ${outputDir}/app.nw.zip --title "Release ${currentVersion} generated by publish.js"`
    );
